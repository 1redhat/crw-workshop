...
image:70-edit-schema-definition[image]
...
----
image:70-schema-definition-commit[image]
...
image:70-repository-release-selector[image]
image:70-repository-release-raw[image]
...
image:70-crc-select-workspace[image]
